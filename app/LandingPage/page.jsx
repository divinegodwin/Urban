    ...
    <div className="mt-[6rem]">
      <div>
        <Image
          ...
          alt="an image"
        />
        <p className="text-center font-bold text-2xl px-4">
          {Images[displayImage].text}
        </p>

        {displayImage !== Images.length - 1 ? (
          <button
            onClick={Next}
            className="bg-[#1746c3] text-white w-[100px] h-[40px] rounded-full float-right mr-10 mt-14"
          >
            Next
          </button>
        ) : (
